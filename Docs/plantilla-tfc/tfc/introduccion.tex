...
\textbf{Random Forest Regressor} {} Este modelo de regresión se implementa siguiendo el trabajo de Breiman \cite{Breiman2001}, donde los árboles de decisión se contruyen a partir de las muestras de datos extraídas con reemplazo del conjunto de entrenamiento. Los árboles de decisión individuales suelen tender al sobreajuste. Los bosques aleatorios lograr reducir la varianza del modelo al combinar diversos árboles, aunque suele ser a costa de un ligero sesgo. La aleatoriedad inyectada en los bosques produce árboles de decisión con errores de predicción desacoplados. Al tomarse el promedio de las predicciones, algunos errores pueden anularse. %TODO_DONE: lo mismo añade detalles sobre random forest
...
En la Figura \ref{fig:benchA_details_1} se adjuntan las gráficas que detallan el rendimiento de los modelos Neural Network, Gaussian Process, kNN y Random Forest. En sus correspondientes gráficas se puede apreciar:
...
\centering
\subfloat[nnet]{\label{fig:benchA_details_nnet_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_A_nnet_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[gp]{\label{fig:benchA_details_gp_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_A_gp_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[knn]{\label{fig:benchA_details_knn_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_A_knn_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[rf]{\label{fig:benchA_details_rf_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_A_rf_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[svm]{\label{fig:benchA_details_svm_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_A_svm_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[dtr]{\label{fig:benchA_details_dtr_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_A_dtr_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[lr]{\label{fig:benchA_details_lr_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_A_lr_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[bayes]{\label{fig:benchA_details_bayes_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_A_bayes_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\end{minipage}
\caption{Benchmark A. Predicción detallada de los modelos svm, dtr, lr y bayes.}
\label{fig:benchA_details_2}
\end{figure*}
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[knn]{\label{fig:benchB1_details_knn_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B1_knn_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[rf]{\label{fig:benchB1_details_rf_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B1_rf_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[svm]{\label{fig:benchB1_details_svm_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B1_svm_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[dtr]{\label{fig:benchB1_details_dtr_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B1_dtr_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[lr]{\label{fig:benchB1_details_lr_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B1_lr_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[bayes]{\label{fig:benchB1_details_bayes_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B1_bayes_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[gp]{\label{fig:benchB1_details_gp_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B1_gp_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[knn]{\label{fig:benchB2_details_knn_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B2_knn_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[rf]{\label{fig:benchB2_details_rf_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B2_rf_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[svm]{\label{fig:benchB2_details_svm_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B2_svm_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\end{minipage}
\caption{Benchmark B2. Predicción detallada de los modelos knn, rf, svm y dtr.}
\label{fig:benchB2_details_1}
\end{figure*}

En la Figura \ref{fig:benchB2_details_2} se adjuntan las gráficas que detallan el rendimiento de los modelos Linear Regressor, Neural Network y Gaussian Process para el Benchmark B2. En sus correspondientes gráficas se puede apreciar:
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[lr]{\label{fig:benchB2_details_lr_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B2_lr_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[nnet]{\label{fig:benchB2_details_nnet_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B2_nnet_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[gp]{\label{fig:benchB2_details_gp_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_B2_gp_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[stacking]{\label{fig:benchC_details_stacking_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_C_stacking_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[nnet]{\label{fig:benchC_details_nnet_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_C_nnet_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[knn]{\label{fig:benchC_details_knn_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_C_knn_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[rf]{\label{fig:benchC_details_rf_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_C_rf_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\end{minipage}
\caption{Benchmark C. Predicción detallada de los modelos stacking, nnet, knn y rf.}
\label{fig:benchC_details_1}
\end{figure*}
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[svm]{\label{fig:benchC_details_svm_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_C_svm_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[dtr]{\label{fig:benchC_details_dtr_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_C_dtr_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[lr]{\label{fig:benchC_details_lr_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_C_lr_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\begin{minipage}{.33\linewidth}
\centering
\subfloat[bayes]{\label{fig:benchC_details_bayes_1}\includegraphics[width=\linewidth]{Figuras/Experimentos/B_C_bayes_1.pdf}}
\end{minipage}%
\begin{minipage}{.33\linewidth}
\centering
...
\end{minipage}
\caption{Benchmark C. Predicción detallada de los modelos svm, dtr, lr y bayes.}
\label{fig:benchC_details_2}
\end{figure*}
...
%TODO_DONE: creo que sería buena idea meter el algoritmo que aparece en el paper de MAMl. Sería copiar el algoritmo 1 que aparece en el artículo y ahbalr un poco de él.
