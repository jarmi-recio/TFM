...
def get_best_stacking():
	...
	level0 = list()
	level0.append(('nnet', MLPRegressor(activation='relu', hidden_layer_sizes=150, learning_rate='invscaling',
										max_iter=200, solver='lbfgs', alpha= 0.001)))
	level0.append(('dtr', DecisionTreeRegressor(min_samples_leaf=5, criterion='mse', splitter='best')))
	level0.append(('rf', RandomForestRegressor(criterion='mse', min_samples_leaf=5, n_estimators=100, random_state=0)))
...
def get_models():
	...
	# Neural Networks
	# best params_1st: {'activation': 'relu', 'alpha': 0.001, 'hidden_layer_sizes': 150, 'learning_rate': 'invscaling',
	...
	#DecisionTree
	# best params: {'criterion': 'mse', 'min_samples_leaf': 5, 'splitter': 'best'}
...
#X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.63, random_state=None, shuffle=False)
