...
#X_train, y_train, X_test, y_test = load('results/test_data.joblib')
X_train, y_train, X_test, y_test = load('results/test_data_for_new_test.joblib')
...
df_final_test.to_csv('df_final_test_nnet.csv')
