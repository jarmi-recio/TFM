...
plt.savefig('../../pics/training_testing/Benchmark_C_MAE_hist.pdf')
...
for name, model in models.items():
	...
	plt.savefig('../../pics/training_testing/Benchmark_C_'+name+'_fig1.pdf')
	...
	plt.legend()
	plt.grid(True)
	plt.savefig('../../pics/training_testing/Benchmark_C_'+name+'_fig2.pdf')
