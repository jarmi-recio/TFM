...
plt.savefig('../../pics/training_testing/Benchmark_B2_MAE_hist.pdf')
...
for name, model in models.items():
	...
	plt.savefig('../../pics/training_testing/Benchmark_B2_'+name+'_fig1.pdf')
	...
	plt.legend()
	plt.grid(True)
	plt.savefig('../../pics/training_testing/Benchmark_B2_'+name+'_fig2.pdf')
...
# saving models
dump(models,'../../models/models_Benchmark_B2_originals.joblib')
