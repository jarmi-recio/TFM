...
models = load('../../models/models_Benchmark_B1_originals.joblib')
...
plt.savefig('../../pics/testing/Benchmark_B1_MAE_hist.pdf')
...
for name, model in models.items():
	...
	plt.savefig('../../pics/testing/Benchmark_B1_'+name+'_fig1.pdf')
	...
	plt.legend()
	plt.grid(True)
	plt.savefig('../../pics/testing/Benchmark_B1_'+name+'_fig2.pdf')
